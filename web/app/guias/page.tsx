    ...
    <main className="min-h-screen pt-28 pb-20">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <AnimatedSection className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-6 text-4xl font-semibold tracking-tighter text-[color:var(--foreground)] md:text-5xl lg:text-6xl">
...
function GuiaCard({ guia }: { guia: Guia }) {
  return (
    ...
    >
      <span className="text-[10px] font-semibold uppercase tracking-[0.15em] text-[color:var(--accent)]">
        {guia.category}
      </span>
      <h2 className="mt-3 text-xl font-semibold leading-snug text-[color:var(--foreground)]/90 transition-colors group-hover:text-[color:var(--foreground)]">
        {guia.title}
      </h2>
      <p className="mt-3 flex-1 text-sm leading-relaxed text-[color:var(--muted-foreground)]">
        {guia.description}
      </p>
      <div className="mt-6 flex items-center justify-between text-xs text-[color:var(--muted)]">
        ...
        <span className="inline-flex items-center gap-1 text-[color:var(--accent)] transition-transform group-hover:translate-x-1">
